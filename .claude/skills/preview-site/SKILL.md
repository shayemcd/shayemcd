---
name: preview-site
description: Serves the site locally and verifies it renders correctly — all JSON data files parse and every section renders from its data. Use to preview the site, check changes after editing data or design files, or debug a section that isn't showing up.
---

...
// detection, partner copy via History, weight chart) plus v2 flows (compact
// set editor, cardio + kcal estimates, 7-day plan add-to-today, rest timer,
// AI meal estimation with shares & bank, macro dashboard, recap, watch data).
